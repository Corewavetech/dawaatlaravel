...
abstract class DataGrid
{
    ...
    protected $addActionIfCondition = [];
    ...
    public function addActionIf(callable $condition, array $action)
    {
        $this->addActionIfCondition[] = compact('condition', 'action');
        dd($this->addActionIfCondition);
    }

    public function getActionsForRow($row)
    {
        dd($this->addActionIfCondition);
        $actions = [];

        foreach ($this->addActionIfCondition as $item) {
