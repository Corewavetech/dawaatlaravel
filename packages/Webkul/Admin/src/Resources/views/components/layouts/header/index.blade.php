...
<header class="sticky top-0 z-[10001] flex items-center justify-between border-b bg-white px-4 py-2.5 dark:border-gray-800 dark:bg-gray-900">
    <div class="flex items-center gap-1.5">
        ...
        <a href="{{ route('admin.dashboard.index') }}">
            ...
            @else
                <img
                    src="{{ request()->cookie('dark_mode') ? bagisto_asset('images/dawat_logo.png') : bagisto_asset('images/dawat_logo.png') }}"
                    id="logo-image"
                    width="130px"
                    height="36px"
                    alt="{{ config('app.name') }}"
        ...
        app.component('v-dark', {
            ...
            data() {
                return {
                    ...
                    logo: "{{ bagisto_asset('images/dawat_logo.png') }}",

                    dark_logo: "{{ bagisto_asset('images/dawat_logo.png') }}",
                };
            },
