<x-admin::layouts>            
    ...
    <x-admin::form :action="route('admin.marketing.blogs.update', ['id'=>$id->id])" method="PUT" enctype="multipart/form-data">
        <!-- Header -->
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap mb-[20px]">
            <p class="text-xl font-bold text-gray-800 dark:text-white">Edit Blog</p>
            ...
            <div class="flex flex-1 flex-col gap-4 max-xl:flex-auto">
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <input type="text" id="author" name="author" placeholder="John Doe" value="{{ $id->auther }}"
                    ...
                    <x-admin::form.control-group>
                        ...
                        <input type="text" id="title" name="title" placeholder="Enter blog title" value="{{ $id->title }}"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300" />
                    ...
                    <x-admin::form.control-group>
                        ...
                        <input type="text" id="slug" name="slug" placeholder="auto-generated-slug" value="{{ $id->url_string }}"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300" />
                    ...
                    <x-admin::form.control-group>
                        ...
                        <textarea name="content" id="content-editor" rows="10"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300">{{ $id->content }} </textarea>
                    ...
                    <x-admin::form.control-group>
                        ...
                        <input type="text" id="seo_title" name="seo_title" placeholder="SEO title" value="{{ $id->seo_title }}"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300" />
                    ...
                    <x-admin::form.control-group>
                        ...
                        <input type="text" id="seo_description" name="seo_description" placeholder="SEO description" value="{{ $id->seo_description }}"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300" />
                    ...
                    <x-admin::form.control-group>
                        ...
                        <input type="text" id="seo_keywords" name="seo_keywords" placeholder="seo Keywords" value="{{ $id->seo_keywords }}"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300" />
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <select name="type" id="type" class="custom-select w-full rounded-md border bg-white px-3 py-2.5 text-sm font-normal text-gray-600 transition-all hover:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400">
                            ...
                            <option value="Recipe" {{ $id->type == 'Recipe' ? 'selected' : '' }}>Recipe</option>
                            <option value="Blog" {{ $id->type == 'Blog' ? 'selected' : '' }}>Blog</option>
                        </select>
                    ...
                    <x-admin::form.control-group>
                        ...
                        <div class="mt-2">
                            <img id="image-preview" src="{{ asset('storage/' . $id->image) }}" alt="Image Preview" class="max-h-40 rounded-md border" />
                        </div>
                    </x-admin::form.control-group>
                    ...
                    <x-admin::form.control-group>
                        ...
                        <input type="text" id="tags" name="tags" placeholder="Enter tags separated by commas" value="{{ implode(', ', $tags) ?? '' }}"
                            class="w-full rounded-md border px-3 py-2.5 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300" />
