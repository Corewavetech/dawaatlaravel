...
use Webkul\Admin\Http\Controllers\Marketing\Blogs\BlogCommentsController;
use Webkul\Admin\Http\Controllers\Marketing\Blogs\BlogsController;
    ...
    Route::prefix('marketing')->group(function () {
        ...
        Route::prefix('blogs')->group(function(){
            ...
            Route::controller(BlogsController::class)->group(function(){
                ...
                Route::get('', 'index')->name('admin.marketing.blogs.index');
                Route::get('/create', 'create')->name('admin.marketing.blogs.create');
                Route::post('/store', 'store')->name('admin.marketing.blogs.store');
                Route::get('/edit/{id}', 'edit')->name('admin.marketing.blogs.edit');
                Route::put('/edit/{id}', 'update')->name('admin.marketing.blogs.update');
                Route::delete('/edit/{id}', 'destroy')->name('admin.marketing.blogs.delete');
        ...
        Route::prefix('blogs-comments')->group(function(){
            ...
            Route::controller(BlogCommentsController::class)->group(function(){                
                Route::get('', 'index')->name('admin.marketing.blogs.comment.index');
                Route::get('/view', 'view')->name('admin.marketing.blogs.create');
                Route::get('/approve/{id}', 'approve')->name('admin.marketing.blog-comments.approve');
                Route::get('/reject/{id}', 'reject')->name('admin.marketing.blog-comments.reject'); 
                Route::delete('/delete/{id}', 'destroy')->name('admin.marketing.blog-comments.delete');
            });
