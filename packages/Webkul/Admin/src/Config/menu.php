...
return [
    ...
    [
        'key'        => 'marketing.blogs',
        'name'       => 'Blogs',
        'route'      => 'admin.marketing.blogs.index',
        'sort'       => 2,
        'icon'       => '',
    ],   
    [
        'key'        => 'marketing.blogs.comments',
        'name'       => 'Blog Comments',
        'route'      => 'admin.marketing.blogs.comment.index',
        'sort'       => 3,
        'icon'       => '',
    ],     
    [
        'key'        => 'marketing.blogs.blogs',
        'name'       => 'Blogs',
        'route'      => 'admin.marketing.blogs.index',
        'sort'       => 2,
        'icon'       => '',
    ...
    [
        'key'        => 'marketing.blogs.blogs.comments',
        'name'       => 'Blog Comments',
        'route'      => 'admin.marketing.blogs.comment.index',
        'sort'       => 3,
        'icon'       => '',
