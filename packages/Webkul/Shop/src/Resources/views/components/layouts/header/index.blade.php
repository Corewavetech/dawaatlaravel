            ...
            @if($customer != null)
                ...
                <div class="order-md-last">
                    ...
                    <div class="profile_item">
                        ...
                        <a href="/support.html"> <button class="btn btn-link w-100" type="button">Help &
                                Support</button></a>
                    </div>
                                ...
                                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                                    ...
                                    <div class="offcanvas-body">
                                        <ul
                                            ...
                                            <li
                                                class="nav-item {{ request()->is('/') ? 'active' : '' }} hover-underline">
                ...
                <div
                    ...
                    <div class="support-box text-end d-none d-xl-block">
                        <span class="fs-6 bg-white px-3 py-2 rounded-5 d-flex">
                            ...
                            <span id="loyality_text" class="d-flex align-items-center">Loyalty Points</span>
                        </span>
                    ...
                    <form action=" {{ route('shop.search.index') }}" role="search">
                        <div class="position-relative d-flex align-items-center">
                            ...
                            <input type="text" name="query" value="{{ request('query') }}"
                                ...
                                aria-required="true" pattern="[^\\]+" id="searchInput" class="form-control search-input"
