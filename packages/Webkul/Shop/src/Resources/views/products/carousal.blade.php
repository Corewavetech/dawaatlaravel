...
@pushOnce('scripts')
<script type="text/x-template" id="v-featured-product-template">
...
<script type="module">
    app.component('v-featured-product', {
        template: '#v-featured-product-template',
        ...
        methods: {
            getProducts() {
                ...
                this.$axios
                    .get('{{ route('shop.api.products.index', ['featured' => 1, 'sort' => 'name', 'limit' => 5]) }}')
                    .then((response) => {
