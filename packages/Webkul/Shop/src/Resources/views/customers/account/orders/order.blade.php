...
@pushOnce('scripts')
    ...
    <script type="text/x-template" id="v-order-section-template">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mx-auto">
                            <!-- List group-->
                            <ul class="list-group order_item_list">
                                <!-- list group item-->
                                        ...
                                        <div
                                            ...
                                            <div class="media-body order-2 order-lg-1">
                                                <div
                                                    ...
                                                    <h5 class="mt-0 font-weight-bold mb-2"> Daawat Dubar
                                                        -
                                                        Baasmati Rice </h5>
                                                    <h6>Placed on - 20/04/2025</h6>
                                                </div>
                                                <p class="font-italic text-muted mb-0 small">10kg |
                                                    Premium quality rice with long grains, rich aroma,
                                                    and
                                                    exceptional purity. Available in various pack sizes
                                                    to
                                                    suit your needs — ideal for everyday cooking with
                                                    the
                                                ...
                                                <div
                                                    ...
                                                    <h6 class="font-weight-bold my-2">₹2,999</h6>
                                                    
                                                    <ul class="list-inline small">
                                                        <span
                                                            class="text-bg-secondary  position-absolute top-20 start-60 translate-middle badge rounded-pill ">
                                                            Placed
                                                        </span>
                                                    </ul>
                                                </div>
                                            </div>
                                            <img src="/images/png/product_img.png"
                                                alt="Generic placeholder image" width="200"
                                                class="ml-lg-5  order-lg-2 order_item_img">
                                        </div>
                                    </a>
                                    <!-- End -->
                                </li> <!-- End -->
                                    ...
                                    <div
                                        ...
                                        <div class="media-body order-2 order-lg-1">
                                            <div
                                                ...
                                                <h5 class="mt-0 font-weight-bold mb-2">Daawat Dubar -
                                                    Baasmati Rice</h5>
                                                <h6>Cancelled on - 20/04/2025</h6>
                                            </div>
                                            <p class="font-italic text-muted mb-0 small">10kg |
                                                Premium quality rice with long grains, rich aroma, and
                                                exceptional purity. Available in various pack sizes to
                                                suit your needs — ideal for everyday cooking with the
                                                authentic taste of basmati.
                                            ...
                                            <div
                                                ...
                                                <ul class="list-inline small">
                                                    <span
                                                        class="text-bg-danger position-absolute top-20 start-60 translate-middle badge rounded-pill ">
                                                        Cancelled
                                                    </span>
                                                </ul>
                                            </div>
    ...
    <script type="module">
        app.component('v-order-section', {
            template: '#v-order-section-template',
