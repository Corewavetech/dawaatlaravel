...
Route::group(['middleware' => ['locale', 'theme', 'currency']], function () {
    ...
    Route::prefix('customer')->group(function () {
        ...
        Route::controller(SessionController::class)->prefix('login')->group(function () {
            ...
            Route::post('sendotp', 'mobileLogin')->name('shop.customer.session.sendotp');
            Route::get('verify', [SessionController::class, 'showVerifyForm'])->name('shop.customers.session.verify.form');
            Route::post('verify-otp', 'verify_login')->name('shop.customer.session.verifylogin');
        ...
        Route::controller(RegistrationController::class)->group(function () {
            Route::prefix('register')->group(function () {
                ...
                Route::post('new-user-store', 'newUserStore')->name('shop.customers.register.add');
                Route::get('verify', 'showVerifyForm')->name('shop.customers.register.verify.form');
                Route::post('verify-otp', 'verify_register')->name('shop.customer.register.verifyregister');
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                Route::controller(AddressController::class)->prefix('addresses')->group(function () {
                    ...
                    Route::get('help-and-support', 'help_and_support')->name('shop.customers.account.support');
                });
